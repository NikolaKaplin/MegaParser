...
async function updateToken(cookie: string) {
  ...
  fs.writeFileSync(jsonFilePath, JSON.stringify(newTokens.data, null, 2), "utf-8")
...
async function getCookie() {
  ...
  page.on("request", async (request) => {
    if (request.url() === "https://app.chizhik.club/api/v1/geo/cities/?name=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0") {
      cookie = await request.allHeaders();
    }
  });
  await page.goto("https://app.chizhik.club/api/v1/geo/cities/?name=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0",
